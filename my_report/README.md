...
[Τελικό αποτέλεσμα](https://github.com/dpsd19080/Digital-Storytelling-Individual-Assignment/tree/main/dailies/Deliverable2/Unit6)
...
# 3rd Deliverable 
Στο τελευταίο παραδοτέο δεν υπήρχαν creative challenges οπότε έμενε απλως να ολοκληρώσω το δικό μου animation. 
...
![Alt Text](https://github.com/dpsd19080/Digital-Storytelling-Individual-Assignment/blob/main/my_report/final_render.gif)
